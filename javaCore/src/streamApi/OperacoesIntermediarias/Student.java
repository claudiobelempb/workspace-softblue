...
public record Student(String name, Year yearOfBirth, List<Double> grades) {
	public static List<Student> list() {

		return List.of(new Student("José", Year.of(2009), List.of(8.5, 10.0, 9.8)),
				new Student("Pedro", Year.of(2006), List.of(7.0, 7.0, 7.0)),
				new Student("Maria", Year.of(2007), List.of(6.5, 9.0, 4.8)),
